...
<div class="panel-group ">
    <div class="panel panel-default ">
        ...
        <div class="panel-body">
            <form class="form-horizontal" role="form" method="POST" action="cadastroPesquisador.do">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" id="tipo" name="tipo">
                            <option <c:if test="${usuario.tipo.value == 1}">selected </c:if>value="1">Pesquisador</option>
