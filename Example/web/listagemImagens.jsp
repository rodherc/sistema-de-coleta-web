...
<div class="panel-group ">
    <div class="panel panel-default ">
        <div class="panel-heading" >
            <h3 class="panel-title">Listagem de Imagens</h3>
        </div>
        <p></p>
        <p></p>
        <div class="panel-body">
            ...
            <div class="row" >
                ...
                <form class="navbar-form navbar-left" role="search" method="POST" action="listagemImagem.do">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <c:forEach items="${imagem}" var="imagem">
                            <tr>
                                <td><c:out value="${imagem.codImagem}"/></td>
                                <td><c:out value="${imagem.nome}"/></td>
                                <td><img src="${imagem.localizacao}" alt="some text" width=100 height=60></td>
                                
                             <td width="10px"><a href="javascript:confirmarExclusao(<c:out value="${imagem.codImagem}"/>,'<c:out value="${imagem.nome}"/>');"><span class="glyphicon glyphicon-trash" style="color:red" title="Excluir"  aria-hidden="true"></span></a></td>
                            
                            </tr>
                        </c:forEach>
                    
                        <td><a href="cadastrarImagem.jsp" label= "Cadastrar" class="btn btn-default btn pull-left" ><span title="Adicionar" /> Adicionar</a></td>
                ...
                <ul class="pagination">
                    ...
                    <%
                        ...
                        if (curPag == 1) {
                            ...
                            prevLink = "listagemImagem.do?curPag=";
                            prevLink += curPag - 1;
                            prevLink += "&nome=";
                            prevLink += nome;
                        }
                    ...
                    %><li <%=active%> ><a href="listagemImagem.do?curPag=<%=i%>&nome=<%=nome%>"><%=i%></a></li><%
                        }
                        %>
...
<script>
    ...
    function excluir(id) {
        $(location).attr('href', "listagemImagem.do?idDelete=" + id);
    }
</script>
