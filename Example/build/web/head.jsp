...
<%@ page import="Administrativo.Pesquisador.Entity.*" %>
<%@ page import="Administrativo.Login.Elementos.*" %>
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown <%if(Modulo.ADMINISTRATIVO.equals(request.getSession().getAttribute("moduloAtual"))) out.println("active");%>">
                                ...
                                <%if (permissoes.hasComponente(Componente.PESQUISADOR)) {%> 
                                
                                    <li><a href="menu.do?componente=<%=Componente.PESQUISADOR.getId()%>">Usuários</a></li>
